export const Icons = {
  ...
  arrowRight: {
    ...
    class:
      "h-4 w-4 flex-shrink-0 transition duration-300 animate-wiggle",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  github: {
    paths: [
      {
        d: "M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9c-1.63 0-3-1.37-3-3s1.37-3 3-3 3 1.37 3 3-1.37 3-3 3z",
      },
    ],
    class:
      "w-4.5 h-4.5 transition flex-shrink-0 text-neutral-700 duration-300 group-hover:-translate-y-1 dark:fill-white",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "currentColor",
  ...
  instagramFooter: {
    paths: [
      {
        d: "M12 2.2c3.2 0 3.6 0 4.9.1 1.2 0 2.1.2 2.7.4.7.3 1.2.6 1.8 1.2.6.6.9 1.1 1.2 1.8.2.6.3 1.5.4 2.7.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c0 1.2-.2 2.1-.4 2.7-.3.7-.6 1.2-1.2 1.8-.6.6-1.1.9-1.8 1.2-.6.2-1.5.3-2.7.4-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2 0-2.1-.2-2.7-.4-.7-.3-1.2-.6-1.8-1.2-.6-.6-.9-1.1-1.2-1.8-.2-.6-.3-1.5-.4-2.7-.1-1.3-.1-1.7-.1-4.9s0-3.6.1-4.9c0-1.2.2-2.1.4-2.7.3-.7.6-1.2 1.2-1.8.6-.6 1.1-.9 1.8-1.2.6-.2 1.5-.3 2.7-.4 1.3-.1 1.7-.1 4.9-.1m0-2.2c-3.3 0-3.7 0-5 .1-1.3.1-2.2.3-3 .6-1 .4-1.8.9-2.6 1.7-.8.8-1.3 1.6-1.7 2.6-.3.8-.5 1.7-.6 3-.1 1.3-.1 1.7-.1 5s0 3.7.1 5c.1 1.3.3 2.2.6 3 .4 1 1 1.8 1.7 2.6.8.8 1.6 1.3 2.6 1.7.8.3 1.7.5 3 .6 1.3.1 1.7.1 5 .1s3.7 0 5-.1c1.3-.1 2.2-.3 3-.6 1-.4 1.8-.9 2.6-1.7.8-.8 1.3-1.6 1.7-2.6.3-.8.5-1.7.6-3 .1-1.3.1-1.7.1-5s0-3.7-.1-5c-.1-1.3-.3-2.2-.6-3-.4-1-1-1.8-1.7-2.6-.8-.8-1.6-1.3-2.6-1.7-.8-.3-1.7-.5-3-.6-1.3-.1-1.7-.1-5-.1zm0 5.8c-3.4 0-6.1 2.7-6.1 6.1s2.7 6.1 6.1 6.1 6.1-2.7 6.1-6.1-2.7-6.1-6.1-6.1zm0 10.2c-2.3 0-4.1-1.9-4.1-4.1 0-2.3 1.9-4.1 4.1-4.1 2.3 0 4.1 1.9 4.1 4.1 0 2.3-1.9 4.1-4.1 4.1zm6.4-10.6c-.8 0-1.4-.6-1.4-1.4s.6-1.4 1.4-1.4 1.4.6 1.4 1.4-.6 1.4-1.4 1.4z",
      }
